...
- [ ] 1.4 Replace the dashboard-dominant global styles with app-shell, sidebar, message, and prompt-composer styling.
...
- [ ] 3.4 Add idempotency handling for `clientRunId` and confirmed execution actions.
- [ ] 3.5 Keep deterministic mock data and fallback paths for family and friends demo scenarios.
...
- [ ] 4.3 Add abort handling so client disconnects cancel unconfirmed planning work safely.
